...
$episode_name = "Team Impossible";
$episode_pages = array ("1-100", "101-200", "201-300", "301-400", "401-500", "501-600", "601-700", "701-800", "801-900", "901-1000", "1001-1100", "1101-1210");
$url = "team_impossible";
$episode_pages2 = array ("1-100", "101-200", "201-300", "301-400", "401-500", "501-600", "601-700", "701-800", "801-900", "901-1000", "1001-1100", "1101-1200", "1201-1300", "1301-1400", "1401-1500", "1501-1600", "1601-1700", "1701-1709");

if ($_GET['mode'] == ""){  
  include ("includes/print_index_hd.php");
}else {
  if ($_GET['v']!="hd"){
      $photogallery = "60_Team_Impossible";
	  if ($_GET['mode'] == "1-100"){
	  	...
	  	$photogallery = "team_impossible_hd";
		if ($_GET['mode'] == "1-100"){
