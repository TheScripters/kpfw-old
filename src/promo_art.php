...
function print_gallery(){
	$dirName = "images/promotional_art/thumb";
	$dp = opendir($dirName);
...
HERE;
  		...
  		$output .= <<<HERE
<td align="center"><a href = "promo_art/view/$currentFile">		
  		<img border = "0" src = "images/promotional_art/thumb/$currentFile" alt="[image]"></a></td>	
HERE;
	$picInRow++;
       if ($picInRow == 2){
           $output .= <<<HERE
...
if ($_GET['mode'] == "view"){
  print "<br><br><center><a href = \"promo_art\">Back</a><br><br><img border = \"0\" src = \"images/promotional_art/".$_REQUEST['pic']."\" atl=\"".$_REQUEST['pic']."\"><br><br>";
  print "</center>";
  footer();
}
?>
