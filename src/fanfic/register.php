    ...
    if (!empty($_REQUEST['mode']))
      {
        ...
        if ($Pass == $Pass1 && !empty($UserName) && !empty($UEmail) && $Code_Confirm == $_SESSION['visual_confirmation'])
          {
